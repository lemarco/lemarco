...
I build **high-load applications** with large datasets. Fintech, iGaming, B2B, B2C — I've shipped in domains where downtime costs money and "we'll fix it in the next sprint" isn't an option.
...
*GitHub is a signpost. GitLab is where the commits happen.*
